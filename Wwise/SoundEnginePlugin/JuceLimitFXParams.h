...
#ifndef JuceLimitFXParams_H
#define JuceLimitFXParams_H
...
struct JuceLimitNonRTPCParams
{
};

struct JuceLimitFXParams
    : public AK::IAkPluginParam
{
    ...
    JuceLimitRTPCParams RTPC;
    JuceLimitNonRTPCParams NonRTPC;
} AK_ALIGN_DMA;

#endif // JuceLimitFXParams_H
