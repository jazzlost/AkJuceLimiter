...
#include "JuceLimitFXParams.h"

#include <AK/Tools/Common/AkBankReadHelpers.h>

JuceLimitFXParams::JuceLimitFXParams()
{
}
...
JuceLimitFXParams::JuceLimitFXParams(const JuceLimitFXParams& in_rParams)
{
...
AK::IAkPluginParam* JuceLimitFXParams::Clone(AK::IAkPluginMemAlloc* in_pAllocator)
{
    return AK_PLUGIN_NEW(in_pAllocator, JuceLimitFXParams(*this));
}
...
AKRESULT JuceLimitFXParams::Term(AK::IAkPluginMemAlloc* in_pAllocator)
{
