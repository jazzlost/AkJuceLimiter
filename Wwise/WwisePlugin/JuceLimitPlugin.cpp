...
#include "JuceLimitPlugin.h"
#include "../SoundEnginePlugin/JuceLimitFXFactory.h"

#include <AK/Tools/Common/AkAssert.h>

JuceLimitPlugin::JuceLimitPlugin()
    : m_pPSet(nullptr)
{
}
...
void JuceLimitPlugin::Destroy()
{
    delete this;
}

void JuceLimitPlugin::SetPluginPropertySet(AK::Wwise::IPluginPropertySet* in_pPSet)
{
    m_pPSet = in_pPSet;
}
